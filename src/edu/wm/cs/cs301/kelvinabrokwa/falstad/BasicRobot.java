...
import edu.wm.cs.cs301.kelvinabrokwa.ui.PlayActivity;
...
public class BasicRobot implements Robot {
	...
	final String BATTERY_FAILURE_MESSAGE = "Your robot ran out of power";
	final String WALL_FAILURE_MESSAGE = "Your robot attempted to walk through a wall";
	...
	public void endGame(boolean won, String reason) {
		playActivity.end(pathLength, (int)(INITIAL_BATTERY_LEVEL - batteryLevel), reason);
	}
	
	public void setPlayActivity(PlayActivity pa) {
		playActivity = pa;
	}
	/**
	 * @return Maze
