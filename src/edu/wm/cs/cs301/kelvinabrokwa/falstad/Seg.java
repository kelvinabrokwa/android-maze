...
import edu.wm.cs.cs301.kelvinabrokwa.falstad.GraphicsWrapper.GWColor;
...
public class Seg {
	...
	Seg(int psx, int psy, int pdx, int pdy, int cl, int cc) {
		...
		switch (part2) {
		case 0: col = new GWColor(val1, 20, 20); break;
		case 1: col = new GWColor(20, val1, 20); break;
		case 2: col = new GWColor(20, 20, val1); break;
		case 3: col = new GWColor(val1, val1, 20); break;
		case 4: col = new GWColor(20, val1, val1); break;
		case 5: col = new GWColor(val1, 20, val1); break;
		default: col = new GWColor(20, 20, 20); break;
		}
	}
