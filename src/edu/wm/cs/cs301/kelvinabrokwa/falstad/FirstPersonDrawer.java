...
public class FirstPersonDrawer extends DefaultViewer {
	 ...
	 */
	public FirstPersonDrawer(int width,
							 int height,
							 int map_unit,
							 int step_size,
							 Cells mazecells,
	...
	// redraw method for Android version
	@Override
	public void redraw(GraphicsWrapper panel,
					   int px,
					   int py,
