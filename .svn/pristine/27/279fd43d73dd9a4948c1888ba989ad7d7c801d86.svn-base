...
public class Constants {
	...
	// maze generation alorithms
	public static final int BUILDER_FALSTAD = 0;
	public static final int BUILDER_PRIM = 1;
	public static final int BUILDER_ELLER = 2;
	
	// drivers
	static final int DRIVER_MANUAL = 0;
	static final int DRIVER_CURIOUS_MOUSE = 1;
	static final int DRIVER_WALL_FOLLOWER = 2;
	static final int DRIVER_WIZARD = 3;
